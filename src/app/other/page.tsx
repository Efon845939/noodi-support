...
export default function Other() {
  ...
  const category = sp.get('category') || 'personal'
    ...
    <div className="min-h-[100svh] bg-white pb-[68px]">
      ...
      <div className="p-4 max-w-md mx-auto">
        ...
        <textarea
          ...
          rows={4} className="w-full border rounded-xl p-3 mb-3" placeholder="Örn. göğüs ağrısı, gaz kaçağı..." />
        <button
          onClick={()=>msg.trim() && r.push(`/status?category=${category}&subtype=${encodeURIComponent(msg)}`)}
